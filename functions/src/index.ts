...
exports.statisticsPublishStatistics = cloudFunctions.scheduler(publishStatistics, '*/2 10,11,12,13,14,15,16 * * *');
exports.statisticsSendStatisticNotification = cloudFunctions.scheduler(sendStatisticNotification, '*/2 10,11,12,13,14,15,16 * * *');
