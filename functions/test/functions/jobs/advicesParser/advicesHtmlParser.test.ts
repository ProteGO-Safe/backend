...
import {parseHtml} from '../../../../src/functions/jobs/advicesParser/advicesHtmlParser';

describe('advicesHtmlParser', function () {
    it('should parse html', function () {
        const exceptedNumberOfAdvices = 18;
        const fs = require('fs');
        const fileContent = fs.readFileSync('./test/functions/jobs/advicesParser/content.html', 'utf8');
        const exceptedJson = fs.readFileSync('./test/functions/jobs/advicesParser/exceptedJson.json', 'utf8');
